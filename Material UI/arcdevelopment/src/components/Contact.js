...
export default function Contact(props) {
    ...
    const onConfirm = () => {
        ...
        axios.get('https://us-central1-material-ui-project-66be8.cloudfunctions.net/sendMail', 
                {
                    params: {
                        name: name,
                        email: email,
            ...
            .catch(err => {setLoading(false); setAlert({open: true, message: "Something went wrong, please try again!",
        ...
        <Grid item container direction="row">
            <Grid item container justify="center" alignItems="center" 
                ...
                <Grid item container style={{marginTop: "2em"}}>
                    ...
                    <Grid item>
                        <Typography variant="body1" style={{color: theme.palette.common.blue, fontSize: "1rem"}}>
                            <a href="tel: (+91) 9876543210" style={{textDecoration: "none", color: "inherit"}}>
                                (+91) 9876543210
                            </a>
                        </Typography>
                    </Grid>
                ...
                <Grid item container style={{marginBottom: "2em"}}>
                    <Grid item>
                        <img src={emailIcon} alt="email" style={{marginRight: "0.5rem", verticalAlign: "bottom"}}/>
                    </Grid>
                    <Grid item>
                        <Typography variant="body1" style={{color: theme.palette.common.blue, fontSize: "1rem"}}>
                            <a href="mailto:anandraopawar08@gmail.com" style={{textDecoration: "none", color: "inherit"}}>
                                anandraopawar08@gmail.com
                            </a>   
                        </Typography>
                    </Grid>
                </Grid>
                <Grid item conatiner direction="column" style={{maxWidth: "20em"}}>
                    ...
                    <Grid item style={{marginBottom: "0.5em"}}>
                        <TextField label="Phone No." id="phone"
                            fullWidth
                    ...
                    <Grid item style={{maxWidth: "20em"}}>
                        <TextField value={message} id="message" multiline rows={10} 
                            fullWidth
                            InputProps={{disableUnderline: true}}
                            onChange={event => setMessage(event.target.value)} className={classes.message} />
                    </Grid>
                            ...
                            <Grid item container direction={matchesSM ? "column" : "row"}
                                ...
                                <Grid item>
                                    <Button
                                        ...
                                        variant="contained" className={classes.sendButton}
                                        onClick={onConfirm}>
                                        {loading ? <CircuarProgress size={30}/> : buttonContents}
                                    </Button>
                                </Grid>
                                </Grid>
                    </DialogContent>
                ...
                <SnackBar open={alert.open} message={alert.message} ContentProps={{style: {backgroundColor: alert.backgroundColor}}} 
                    ...
                    <Grid item container  direction={matchesMD ? "column" : "row"}
                        className={classes.background} alignItems="center" lg={8} xl={9} justify={matchesMD ? "center": undefined}>
                            ...
                            <Grid item>
                                ...
                                <Grid container justify={matchesMD ? "center" : undefined} item>
                                    <Button variant="outlined" 
                                        className={classes.learnButton} component={Link} to="/revolution" onClick={() => props.setValue(2)} >
