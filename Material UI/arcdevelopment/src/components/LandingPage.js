            ...
            <Grid item>
                <Grid container justify="flex-end" alignItems="center" direction="row">
                    ...
                    className={classes.buttonContainer}>
                        <Grid item>
                            <Button className={classes.estimateButton} component={Link} to="/estimate"
            ...
            <Grid item>{/*-----iOS/Android Block-----*/}
                <Grid container direction="row" justify={matchesSM ? "center": "flex-end"} className={classes.serviceContainer} >
                    ...
                    <Grid item style={{marginRight: matchesSM ? 0: "5em"}}>
                        <img alt="iOS/Android App Icon" className={classes.icon} src={mobileAppsIcon} />
                    </Grid>
                </Grid>
            </Grid>
            <Grid item> {/*-----Websites Block-----*/}
                <Grid container direction="row" justify={matchesSM ? "center": undefined} className={classes.serviceContainer} >
                    <Grid item style={{marginLeft: matchesSM ? 0: "5em", textAlign: matchesSM ? "center" : undefined}}>
                        ...
                        <Typography variant="subtitle1">
                            Optimized Search Engines, built for speed.
                        </Typography>
                ...
                <Grid container alignItems="center" justify="center" style={{height: "100em", marginTop: "12em"}}>
                    ...
                    <CardContent>
                        <Grid container direction="column" style={{textAlign: "center"}}>
                            ...
                            <Grid item>
                                <Typography variant="subtitle1">
                                    Visionary insights coupled with cutting-edge technology is recipe for revolution
                                </Typography>
                                <Button variant="outlined" className={classes.learnButtonHero} component={Link} to="/revolution" 
                ...
                <Grid container style={{height: "80em"}} direction="row" alignItems="center" className={classes.infoBackground}>
                        ...
                        <Grid container style={{marginBottom: matchesXS ? "10em" : 0}} direction="column">
                            ...
                            <Grid item>
                                <Button variant="outlined" style={{color: "white", borderColor: "white"}} 
                                    className={classes.learnButton} component={Link} to="/about" onClick={() => props.setValue(3)}>
                                    <span style={{marginRight: 10}}>Learn More</span>
                    ...
                    <Grid item sm style={{marginRight: matchesXS? 0 : matchesSM ? "2em" : "5em", 
                        ...
                        <Grid container direction="column">
                            ...
                            <Grid item>
                                <Button variant="outlined" style={{color: "white", borderColor: "white"}} 
                                    className={classes.learnButton} component={Link} to="/contact" onClick={() => props.setValue(4)} >
                                    <span style={{marginRight: 10}}>Learn More</span>
                                    <ButtonArrow width={10} height={10} fill="white" />
                                </Button>
                            </Grid>
